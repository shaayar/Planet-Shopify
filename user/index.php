...
?>
    ...
    <div id="content">
        <div id="bg" class=" ">
            ...
            <div class="cntr"> <a href="products.php" class="button">
    <div class="button__line"></div>
    <div class="button__line"></div> <span class="button__text">SHOP NOW</span>
 ...
 <div class="container pt-3">
        <div class="row text-center ">
            <div class="col-6 col-md-3 py-3">
                <a href="products.php#men_watch"> <img src="images/watch.jpg" class="img-fluid " alt="" style="border-radius:0.5rem">
...
<div class="text-center pt-4 h3">
    ...
    <div class="container pt-3">
        <div class="row text-center ">
            <div class="col-6 col-md-3 py-3">
                <a href="products.php#ww"> <img src="images/ww1.jpg" class="img-fluid " alt="" style="border-radius:0.5rem">
