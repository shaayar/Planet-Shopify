             ...
             <li class="nav-item dropdown">
                 <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                     ...
                     <div class="dropdown-menu">
                         ...
                         <a href="products.php#men_acc" class="dropdown-item"> Men Accessories </a>
                         <a href="products.php#men_shoes" class="dropdown-item">Men Shoes</a>
                         <a href="products.php#ww" class="dropdown-item">Women Watches</a>
                         <a href="products.php#wshirt" class="dropdown-item"> Women T-Shirts</a>
                         <a href="products.php#wacc" class="dropdown-item"> Women Accessories </a>
                         <a href="products.php#wshoes" class="dropdown-item">Women Shoes</a>
